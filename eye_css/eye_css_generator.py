...
class CSSGenerator:
    ...
    def eye_init():
        """:Date: July 1, 2022."""
        # Fetch the variables from eye_config.yml file
        scrollbar_color = Eye.SCROLLBAR_COLOR
        scrollbar_color_dark = Eye.SCROLLBAR_COLOR_DARK
        scrollbar_width = Eye.SCROLLBAR_WIDTH
        scrollbar_width_small = Eye.SCROLLBAR_WIDTH_SMALL
        scrollbar_height = Eye.SCROLLBAR_HEIGHT
        scrollbar_height_small = Eye.SCROLLBAR_HEIGHT_SMALL
        scrollbar_thumb_color = Eye.SCROLLBAR_THUMB_COLOR
        scrollbar_thumb_color_dark = Eye.SCROLLBAR_THUMB_COLOR_DARK
        scrollbar_thumb_radius = Eye.SCROLLBAR_THUMB_RADIUS
        scrollbar_track_color = Eye.SCROLLBAR_TRACK_COLOR
        scrollbar_track_color_dark = Eye.SCROLLBAR_TRACK_COLOR_DARK
        scrollbar_track_radius = Eye.SCROLLBAR_TRACK_RADIUS
        eye_init_css = f"""
        /* AUTO GENERATED BY EYE CSS - {datetime.datetime.now()} */
        * {{
            ...
            --scrollbar_color_dark: {scrollbar_color_dark};
            --scrollbar_width: {scrollbar_width};
            --scrollbar_width_small: {scrollbar_width_small};
            --scrollbar_height: {scrollbar_height};
            --scrollbar_height_small: {scrollbar_height_small};
            --scrollbar_thumb_color: {scrollbar_thumb_color};
            --scrollbar_thumb_color_dark: {scrollbar_thumb_color_dark};
            --scrollbar_thumb_radius: {scrollbar_thumb_radius};
        ...
        @media (min-width: 1024px) {{
            .lg\:*::-webkit-scrollbar {{
                ...
                max-height: var(--scrollbar_height_small, 2px);    /* For horizontal scrollbar to display. */
                background-color: var(--scrollbar_color, #EEEEEE);
            }}
        }}
        @media (min-width: 1024px) and (prefers-color-scheme: dark) {{
            ...
            *::-webkit-scrollbar-thumb {{
                background-color: var(--scrollbar_thumb_color_dark, #414141);
            }}
